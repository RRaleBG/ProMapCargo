(() => {
    ...
    function getRootForMap(map) {
        ...
        return (
            container.closest("[data-map-layers]") ||
            container
        );
    }
    ...
    function installMapHook() {
        ...
        window.ProMap.MapLayers.attach =
            attach;

        window.ProMap.MapLayers.loadConfig =
            loadConfig;

        window.ProMap.MapLayers.createTileLayer =
            (
                definition,
                options = {}
            ) => {
